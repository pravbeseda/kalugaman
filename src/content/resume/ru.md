...
Строю поддерживаемые бизнес-приложения на **Angular**: декомпозирую монолиты в
лёгкие
сервисы и компоненты, покрываю код unit- и e2e-тестами, слежу за **чистой
архитектурой**. Использую AI для анализа и написания кода — с обязательным ревью
